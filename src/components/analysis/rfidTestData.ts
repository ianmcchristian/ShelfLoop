...
const RAW_PLACEMENTS: [number, string, string, string, string | null][] = [
  ...
  // Box 5 — short labels, different tag batch; still has a few unresolved / duplicate-label conflicts
  ...
  [5,'Left','TL','AE16','E2801191A5040076300BAE16'],[5,'Left','TR','6996','E2801191A5040076300B6996'],[5,'Left','BL','6906','E2801191A5040076300B6906'],[5,'Left','BR','6986','E2801191A5040076300B6986'],
  [5,'Right','TL','6986',null],[5,'Right','TR','AE46','E2801191A5040076300BAE46'],[5,'Right','BL','6956','E2801191A5040076300B6956'],[5,'Right','BR','AE06','E2801191A5040076300BAE06'],
  ...
  // Box 6 — almost fully resolved; Box 6 Back still only has 1 slot in source data
  ...
  [6,'Right','TL','28452D5','E28011B0A502006C028452D5'],[6,'Right','TR','2835884','E28011B0A502006C02835884'],[6,'Right','BL','2847874','E28011B0A502006C02847874'],[6,'Right','BR','283A0B5','E28011B0A502006C0283A0B5'],
  ...
  // Box 7 — Front TL verified by photo as 1BCAEBA; Top TR cleared pending re-check
  ...
  [7,'Top','TL','1BC625A','E28011B0A5050070B1BC625A'],[7,'Top','TR','',null],[7,'Top','BL','1BC62BA','E28011B0A5050070B1BC62BA'],[7,'Top','BR','1BC88AA','E28011B0A5050070B1BC88AA'],
  ...
  [8,'Front','TL','5C16F18','E28011B0A5020066E5C16F18'],[8,'Front','TR','5C16F58','E28011B0A5020066E5C16F58'],[8,'Front','BL','5C12908','E28011B0A5020066E5C12908'],[8,'Front','BR','AB364','E2801191A5040076300AB346'],
